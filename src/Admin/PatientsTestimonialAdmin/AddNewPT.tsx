...
import { useCreatePTMutation } from '../../API/PTApi';
...
function AddNewPT() {
    ...
    const[createPT]=useCreatePTMutation();
    ...
    const handleSubmit=async(e:React.FormEvent<HTMLFormElement>)=>{
        ...
        const response:ApiResponseInterface=await createPT(formData);
        if(response.data?.isSuccess==true){
            setLoading(false);
            Toastify("Patients Testimonial added successfully");
  ...
  return (
    <div className='container'>
        <h1 className='text-success'>Add New Patients Testimonial</h1>
...
export default AuthHOC(AddNewPT)